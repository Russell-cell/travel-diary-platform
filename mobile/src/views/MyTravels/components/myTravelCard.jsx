...
import { AntDesign, Ionicons } from '@expo/vector-icons'; // 添加Ionicons
import MyDialog from '../../../components/myDialog';

const MyTravelCard = ({ id, photo, title, content, status, location, rejectedReason, fetchTravels,videos }) => {
    ...
    <Card style={styles.card}>
      ...
      <View style={styles.topContainer}>
        <View style={styles.imageWrapper}>
          <Image
            source={{ uri: photo && photo.length > 0 ? photo[0].uri : 'https://via.placeholder.com/100' }}
            style={styles.image}
          />
          {/* 添加视频图标指示器 */}
          {hasVideo && (
